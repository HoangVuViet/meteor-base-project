...
export class GridProvider extends Component<Props, State> {
  ...
  moveItem = (sourceId: any, destinationId: any) => {
    ...
    const destinationIndex = items.findIndex((item: any) => item.id === destinationId);
