...
import ResetPasswordDesktop from '../../resetPassword/components/ResetPasswordDesktop';
import ResetPasswordSuccess from '../../resetPassword/components/ResetPasswordSuccess';
...
const SetPassword: React.FC<Props> = props => {
  ...
  return (
    <>
      <Helmet>
        <title>{intl.formatMessage({ id: !success ? 'setPassword' : 'setPasswordSuccess' })}</title>
      </Helmet>
      {!success ? (
        <ResetPasswordDesktop isSetPassword loading={loading} onChangePassword={onChangePassword} />
      ) : (
