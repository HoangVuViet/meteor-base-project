...
const HudManagementtable: React.FunctionComponent<IHudManagementtableProps> = (props) => {
  ...
  return (
    <div style={{ width: '80%' }}>
      ...
      >
        ...
        >
          <FormattedMessage id="listDisPlay" values={{ value: 'độ ẩm' }} />
        </Typography>
        <LoadingButton
          variant="contained"
          color="secondary"
      ...
      >
        ...
        <DialogContent style={{ alignItems: 'center' }}>
          <Formik initialValues={{}} onSubmit={() => {}}>
            {({ values }) => (
              <Form>
                <EditHudDialog rowData={rowData} values={values} />
                <Divider />
...
export default HudManagementtable;
