...
interface IPressManagementTableProps {
  loading: boolean;
  dataList?: some[];
...
const PressManagementTable: React.FunctionComponent<IPressManagementTableProps> = (props) => {
  ...
  return (
    <div style={{ width: '80%' }}>
      ...
      >
        ...
        >
          <FormattedMessage id="listDisPlay" values={{ value: 'áp suất' }} />
        </Typography>
        <LoadingButton
          variant="contained"
          color="secondary"
      ...
      >
        ...
        <DialogContent style={{ alignItems: 'center' }}>
          <Formik initialValues={{}} onSubmit={() => {}}>
            {({ values }) => (
              <Form>
                <EditPressDialog rowData={rowData} values={values} />
                <Divider />
...
export default PressManagementTable;
